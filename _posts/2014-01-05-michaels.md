...
<div class="row">
	<div class="large-4 push-8 columns">
		<p>
			As different device APIs (such as gestures or location) become available on different devices, they are leveraged to make the site more efficient for users.
		</p>
	</div>
	<div class="large-8 pull-4 columns">
